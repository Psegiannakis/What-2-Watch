...
export default function Carousel1() {
  ...
  if (deckQuery.isLoading || cardsQuery.isLoading) {
    return (
      <div
        className="min-h-screen flex flex-col items-center justify-center bg-slate-700"
        role="status"
      >
        <svg
          aria-hidden="true"
          className="w-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 flex flex-col items-center justify-center"
          viewBox="0 0 100 101"
          fill="none"
